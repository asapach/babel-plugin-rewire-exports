...
exports.qux = exports.default = exports.baz = exports.bar = void 0;
...
exports.whatsit = exports.whatnot = exports.whatever = void 0;
var bar = exports.qux = exports.bar = /*#__PURE__*/_regenerator().m(function bar() {
...
var baz = exports.baz = true;
var whatsit = exports.whatsit = /*#__PURE__*/function (_foo) {
  function whatsit() {
    _classCallCheck(this, whatsit);
    return _callSuper(this, whatsit, arguments);
  }
  _inherits(whatsit, _foo);
  return _createClass(whatsit);
}(foo);
var whatnot = exports.whatnot = false,
  whatever = exports.whatever = true;
var _default = foo,
  _bar = bar,
  _qux = bar,
  _baz = baz,
